...
$$.Hostnode = {"": "Object;m_ip,m_mouseover,m_closeicon",
  ...
  generate_nodeadd$2: function($parent, $name) {
    ...
    t1.insertAdjacentElement$2(lielement, "afterBegin", $._ElementFactoryProvider_createElement_html("<div class='thumbnail' id='thumbnail" + $name + "'>" + "<div class='imgclass' id='closeicon" + $name + "'>" + "<div class='mycircle_out_class' id='mycircle" + $name + "'>" + "<img id='imgclose" + this.m_ip + "' src='./img/del.png' style='display:none ;width: 18px; height: 18px'></img>" + "</div>" + "</div>" + "<img src='./img/add.png' style='width: 180px; height: 180px'>" + "<div class='caption'>" + this.m_ip + "</div></div>"));
...
$.generate_addview = function() {
  var element = $._ElementFactoryProvider_createElement_html("<li class='span3'><div class='thumbnail' id='thumbnail_view'><div class='imgclass' id='closeicon'><div class='mycircle_out_class' id='mycircle'></div></div><img data-src='holder.js/140x140' alt='100x100' src='./img/add.png' style='width: 180px; height: 180px'><div class='caption'>new......</div></div></li>");
